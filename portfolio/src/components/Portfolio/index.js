...
<Row className="portfolio-header"  >
  ...
  <Row className="second-row">
    ...
    <a href="https://protected-shore-03622.herokuapp.com/" target="blank"><p>Note-Taker</p></a>
      </Col>
      <Col xs={12} md={6} sm={12} className="grid-col" >
  ...
  <Row className="third-row">
    ...
    <a href="https://arcane-everglades-49918.herokuapp.com/"><p>Music eXchange</p></a>
    
      </Col>
      <Col xs={12} md={6} sm={12} className="grid-col">
      <img src={Ipad} alt="Code Refactor"/>
      <a href="https://damp-waters-57453.herokuapp.com/" target="blank"><p>Google Book Search</p></a>
      </Col>
